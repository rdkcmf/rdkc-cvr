...
#define RDKC_STRAM_FLAG_ABSTIMESTAMP                    0x08
...
class CVR {
	...
	/* rtmessage */
      ...
      static void notify_smt_TN(cvr_clip_status_t status, const char* clip_name,  unsigned int event_ts = DEFAULT_EVT_TSTAMP);
#endif
    ...
    public:
      CVR();
      ~CVR();
      int cvr_init(char *argv,CloudRecorderConf *pCloudRecorderInfo);
